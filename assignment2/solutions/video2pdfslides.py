...
MAX_PERCENT = 0.2                  # max % of diff between foreground and background to detect if frame is still in motion
...
#     output_folder_screenshot_path = initialize_output_folder(video_path)
    ...
    with open("/autograder/source/tests/solutions/knn.py") as f:
        print(f.read())
